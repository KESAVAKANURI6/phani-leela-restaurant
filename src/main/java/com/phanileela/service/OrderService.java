...
public class OrderService {
    ...
    public Map<String, Object> placeOrder(Map<String, Object> orderRequest) {
        try (Session session = driver.session()) {
            ...
            long orderSeq = session.run("MATCH (o:Order) RETURN count(o) as cnt").single().get("cnt").asLong() + 1;
            String tableNumber = String.valueOf(orderSeq);
            ...
            response.put("tokenNumber", orderSeq);
